 ...
 */
package com.nesea.corsoaem.projectwork.core.models;
...
import com.nesea.corsoaem.projectwork.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "app-web-projectwork/components/helloworld");
